...
function DataFetcher() {
  ...
  const [picTriger, setPicTriger] = useState(0);
  ...
  return (
    <div>
      <Header/>
      <a className="btn btn-primary" href="http://localhost:3000/addtrainers">
        add trainer
      </a>
      <br/>
      <button className="btn btn-dark"   onClick={handelRefresh}>
            ...
            <div className="col-sm-4">
              <div className="card" style={{ width: "18rem" }}>
                ...
                <ul className="list-group list-group-flush">
                  <li className="list-group-item">{dt.speciality}</li>
